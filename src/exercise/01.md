...
We can create elements such as divs/nodes in javascript by accessing 
the DOM created with HTML and applying
methods in javascript that target those nodes.
...
.className = 'container'
.append() or document.body.append()
